...
parser.add_argument('--num-lbfgs-steps', type=int, default=100,
                    help='number of L-BFGS steps to take')
...
def main_worker(gpu, args):
    ...
    # LBFGS training
    clf = train(X, y, criterion, optimizer, clf, args, n_steps=args.num_lbfgs_steps)
...
def train(X, y, criterion, optimizer, clf, args, n_steps=500):
    batch_time = AverageMeter('Time', ':6.3f')
    data_time = AverageMeter('Data', ':6.3f')
